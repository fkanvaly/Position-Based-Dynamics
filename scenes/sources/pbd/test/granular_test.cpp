...
void scene_model::create_rigid_body()
{
    ...
    scene_objects.add_granular( granular(particules, scene_objects.No, mu_frcition(10,10), origin, width, height, color_LUT[ scene_objects.No%color_LUT.size() ] ) );
